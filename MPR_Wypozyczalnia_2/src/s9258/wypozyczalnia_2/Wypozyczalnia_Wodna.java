...
public class Wypozyczalnia_Wodna {
	
private String Nazwa;
List<SprzetWodny> SprzetyWodne = new ArrayList<SprzetWodny>();
List<Klient> Klienci = new ArrayList<Klient>();

public Wypozyczalnia_Wodna(String nazwa, List<s9258.wypozyczalnia_2.SprzetWodny> sprzetwodny,
List<s9258.wypozyczalnia_2.Klient> klient)
{
this.Nazwa = nazwa;
...
public void zmienSprzetWodny(String nazwa, String typ, int rok_produkcji, String nowa_nazwa, String nowy_typ, int nowy_rok_produkcji) {
SprzetyWodne.set(SprzetyWodne.indexOf(znajdzSprzetWodny(nazwa)), new SprzetWodny(nowa_nazwa, nowy_typ, nowy_rok_produkcji));
}
