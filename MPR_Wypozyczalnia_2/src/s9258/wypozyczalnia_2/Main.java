...
Wypozyczalnia_Wodna nowa = new Wypozyczalnia_Wodna("nowa", SprzetyWodne, Klienci);
...
System.out.println("-----------------------------");
nowa.pokazSprzetyWodne_po_typie(nowa.znajdzSprzetWodny_po_typie("2-osobowy"));
System.out.println("-----------------------------");
...
nowa.zmienSprzetWodny("Kanadyjka", "2-osobowy", 1992, "Kanadyjka","3-osobowy", 2012 );
nowa.zmienSprzetWodny("Banan", "2-osobowy", 1976,"Banan", "3-osobowy", 2010 );
